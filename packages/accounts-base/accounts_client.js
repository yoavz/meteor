 ...
 *     the resume token
 *
 * @method  callLoginMethod
 * @memberOf Accounts
 * @param  {Object} options
 * @param {String} options.methodName The method to call. Default is login.
 * @param {Array} options.methodArguments The arguments for the method.
 * @param {String} options.validateResult If provided, will be called with the
 * result of the method. If it throws, the client will not be logged in (and
 * its error will be passed to the callback).
 * @param {Function} options.userCallback Will be called with no arguments once the
 * user is fully logged in, or with the error on error.
 */
 ...
 * @return {Boolean} Whether the loginServiceConfiguration subscription is ready.
 */
